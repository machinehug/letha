...
function validateContactForm(input) {
    ...
    if (firstNameValidated &&
        ...
        validationSuccessTag.classList.add("validation-create-account-success-txt");
        const validationSuccessMessage = document.createTextNode("Your account was created. We sent you an email with a link to verify your account. After verifying it you can log in.");
